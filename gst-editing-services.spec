...
BuildRequires:  gcc
BuildRequires:	gstreamer1-devel >= 1.19.1-7
BuildRequires:	gstreamer1-plugins-base-devel >= 1.19.1-7
BuildRequires:	gstreamer1-plugins-bad-free-devel >= 1.19.1-7
...
%meson \
	-D validate=disabled \
	-D doc=disabled \
	-D package-name="GStreamer Editing Services" \
        -D package-origin=" https://unitedrpms.github.ion "
...
- Rebuilt with the real version 1.19.1
- Upstream
...
* Mon Nov 23 2015 Wim Taymans <wim.taymans@gmail.com> - 1.19.1-1
- update to 1.19.1
